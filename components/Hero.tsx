...
const Hero = () => {
  return (
    <section className=" max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py20 xl:flex-row border-2">
      ...
      <div className="relative z-10 flex flex-1 flex-col xl:w-1/2">
        ...
        <h1 className="bold-52 lg:bold-88">
          Putuk Turno Camp Area
        </h1>
        <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente
          provident ut hic accusantium. Assumenda eos tempore labore, ab, minima
          provident laborum, ipsa exercitationem recusandae deleniti expedita
          aspernatur. Illo, neque architecto.
        </p>
